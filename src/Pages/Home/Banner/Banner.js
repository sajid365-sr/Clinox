...
const Banner = () => {
      ...
      <div className="relative h-full">
        <div className="lg:w-2/5 w-3/4 text-center lg:text-left mx-auto pt-36">
          <p className="tracking-widest">
            ...
            <img className="w-1/2 -ml-5 hidden lg:block -mt-10" src={textShape} alt="" />
    ...
    <img className="absolute w-14 lg:w-auto top-1/2 right-16" src={bacteria} alt="" />
    <img className="absolute w-24 lg:w-auto top-20 lg:top-1/4 lg:right-28" src={bacteria2} alt="" />
    <img src={cleaner} className='absolute top-24 cleaner left-80' alt="" />
    <img src={line} className='absolute hidden lg:block top-5 left-0' alt="" />
    <img src={lineArrow} className='absolute bottom-1/4 lg:right-1/3' alt="" />
    <img src={smallCircle} className='absolute right-64 top-24 lg:top-36' alt="" />
    <img src={cleanMan} className='hidden lg:block absolute w-1/3 top-8 cleanMan' alt="" />
    <img src={expShape} className='absolute w-48 lg:w-auto expShape lg:bottom-08 lg:right-14 right-36 bottom-6' alt="" />
