          ...
          <Fragment>
            <Accordion open={open === 1} animate={customAnimation}>
              ...
              <AccordionBody>
                ...
                custom bid to meet the customer’s needs with a guarantee on the
            ...
            <Accordion open={open === 2} animate={customAnimation}>
              ...
              <AccordionBody>
                ...
                surface so using unknown products could potentially damage your
                house if not used currently. We are also making efforts to be
                environmentally aware by eliminating paper surveys and adding
                non-toxic products. We are constantly making changes to better
                the working environment for our employees and to make sure we
                can deliver a better service for our customers. The following is
                a list of products our housekeeping employees use on regular
                basis:
                <li>
                  Green Earth Natural APC: This product is used as an
                  all-purpose cleaner.
                </li>
                <li>Green Earth Glass Cleaner: Used on all glass surfaces.</li>
                <li>
                ...
                <li>
                  Vinegar: Is used on request on glass surfaces and on hardwoods
                  diluted with water to wash them.
                </li>
              </AccordionBody>
            </Accordion>
