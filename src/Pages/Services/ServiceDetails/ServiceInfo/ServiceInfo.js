    ...
    <div className="container  mx-auto my-20">
      <div className="flex lg:flex-row flex-col-reverse">
          ...
          <div className="flex lg:flex-row flex-col-reverse justify-between items-center">
            <div className="highlightContainer">
              ...
              <p className="mt-5 text-xl">
                Within{" "}
                <span className="text-4xl text-orange-400 text-semibold">
                  {duration}
                </span>{" "}
                days
              </p>
            ...
            <div className="flex mt-10 lg:mt-0 gap-5 flex-row lg:flex-col justify-center items-center">
              <div className="text-center">
                ...
                <p className="text-sm tracking-widest">Satisfaction Rate</p>
              </div>
              <div className="text-center">
        ...
        <div className="w-11/12 mx-auto lg:w-2/5">
          <img
            className="h-full lg:rounded-r-2xl lg:rounded-tl-none rounded-t-2xl"
            src={picture}
            alt=""
          />
        </div>
