      ...
      <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 container mx-auto">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex gap-3 justify-between">
            <img
              className="w-1/2 hover:cursor-pointer hover:-translate-y-2 transition-all ease-in-out duration-300"
              src={google}
              alt="Google Play"
            />
            <img
        ...
        <div className="ml-10">
          ...
          <ul className="text-white">
            <li className="mb-4">
              <Link to="/home" data-replace="Home">
                <span>Home</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link to="/services" data-replace="Services">
                <span>Services</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link to="/blog" data-replace="Blog">
                <span>Blog</span>
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="text-white">
            <li className="mb-4">
              <Link data-replace="Twitter">
                <span>Twitter</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link data-replace="Facebook">
                <span>Facebook</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link data-replace="Contact Us">
        ...
        <div>
          <h2 className="mb-10 text-xl  font-semibold text-white">Legal</h2>
          <ul className="text-white">
            <li className="mb-4 hover:translate-x-2 transition-all ease-in duration-300">
              <Link data-replace="Privacy Policy">
                <span>Privacy Policy</span>
              </Link>
            </li>
            <li className="mb-4 hover:translate-x-2 transition-all ease-in duration-300">
              <Link data-replace="Terms &amp; Conditions">
